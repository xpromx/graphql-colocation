...
export type CharacterCardFragment = { __typename?: 'Character', id?: string | null, name?: string | null, image?: string | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    characters(variables?: CharactersQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<CharactersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CharactersQuery>(CharactersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'characters');
    }
  };
}
